...
public class Mob4 : MonoBehaviour
{
    ...
    public void Awake()
    {
        if (S4instance != null)
        {
            Debug.LogWarning("Il y a plus d'une instance de Enemy Patrol4 dans la scène");
            return;
        }
    ...
    {
        //Mob4.Sinstance.enabled = false;
        Mob4.S4instance.SlimeAnimator.SetTrigger("Died");
        Mob4.S4instance.Srb.bodyType = RigidbodyType2D.Kinematic;
        Mob4.S4instance.Srb.velocity = Vector3.zero;
        Mob4.S4instance.SlimeCollider.enabled = false;
        Debug.Log("Mob4 eliminated");
    }
}
