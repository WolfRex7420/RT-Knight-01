...
public class Mob6 : MonoBehaviour
{
    ...
    public void Awake()
    {
        if (S6instance != null)
        {
            Debug.LogWarning("Il y a plus d'une instance de Enemy Patrol6 dans la scène");
            return;
        }
    ...
    public void TakeDamage6(int amount)
    {
        health -= amount;
    }
    ...
    {
        //Mob6.Sinstance.enabled = false;
        Mob6.S6instance.SlimeAnimator.SetTrigger("Died");
        Mob6.S6instance.Srb.bodyType = RigidbodyType2D.Kinematic;
        Mob6.S6instance.Srb.velocity = Vector3.zero;
        Mob6.S6instance.SlimeCollider.enabled = false;
        Debug.Log("Mob6 eliminated");
    }
}
