...
public class Mob5 : MonoBehaviour
{
    public float speed;
    ...
    public void Awake()
    {
        if (S5instance != null)
        {
            Debug.LogWarning("Il y a plus d'une instance de Enemy Patrol5 dans la scène");
            return;
        }
    ...
    public void TakeDamage5(int amount)
    {
        health -= amount;
    }
    ...
    {
        //Mob5.Sinstance.enabled = false;
        Mob5.S5instance.SlimeAnimator.SetTrigger("Died");
        Mob5.S5instance.Srb.bodyType = RigidbodyType2D.Kinematic;
        Mob5.S5instance.Srb.velocity = Vector3.zero;
        Mob5.S5instance.SlimeCollider.enabled = false;
        Debug.Log("Mob5 eliminated");
    }
}
